...
- **Shared Daily Test — direction decided 2026-09-22:** one generated Daily
  ...
  *(Update 2026-09-26, later: the proxy side (cron generation and the read route) is deployed; the client side has not started. See `docs/build-log.md`, 2026-09-26, "first deploy".)*

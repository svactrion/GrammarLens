...
| **First-day paywall moved to Home, after the climb, once.** | 2026-09-22 | The Day-0 result screen ended in a paywall card right after the first win, before the mountain moved. Hypothesis: the moment after a visible win converts better. | Paywall card at the end of the Day-0 result screen: removed. | Implemented; the flow (climb, then paywall) device-confirmed 2026-09-22. | BL 2026-09-22 (the first-day paywall moves to Home …); BL 2026-09-24 (build 3 submitted …); RM:310-320; PRD2 §13.14 |
